...
\insertimage[]{img/imagenes/modelexces}{width=10cm}{En primera instancia se realiza un cálculo teórico de los valores de los coeficientes de actividad. Estos valores luego son analizados y se realiza un ajuste a modelos, con los cuales se pueden resolver los problemas planteados.}
